            ...
            module OperationsService
              class Service
                ...
                rpc :GetDividendsForeignIssuer,
                    ::Tinkoff::Public::Invest::Api::Contract::V1::GetDividendsForeignIssuerRequest, ::Tinkoff::Public::Invest::Api::Contract::V1::GetDividendsForeignIssuerResponse
                # GetOperationsByCursor — список операций по счету с пагинацией
                # При работе с методом учитывайте [особенности взаимодействия](/invest/services/operations/operations_problems).
                rpc :GetOperationsByCursor, ::Tinkoff::Public::Invest::Api::Contract::V1::GetOperationsByCursorRequest,
